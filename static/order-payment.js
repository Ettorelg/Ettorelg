window.AlphaPayment = (() => {
  ...
  async function open(order, {csrf, onComplete=()=>{}, initialPayment='contanti', initialTender=''}={}) {
    ...
    try {
      ...
      const print=element(tools,'button','🖨 Comanda');print.onclick=()=>AlphaOrderPrint.direct(info.ordine);
